...
describe('NotificationService', () => {
  ...
  it('should get permission status', inject([NotificationService], (service: NotificationService) => {
    service.nativeNotification = notification;
    const result = service.permission;
    expect(result).toEqual('default');
  }));

  it('should request notification permission', inject([NotificationService], (service: NotificationService) => {
    service.nativeNotification = notification;
  ...
  it('should send notification', inject([NotificationService], (service: NotificationService) => {
