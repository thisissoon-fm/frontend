...
describe('QueueComponent', () => {
  ...
  it('should get queue data from store', async(() => {
    ...
    expect(mockStore.select).toHaveBeenCalledWith(fromPlayerStore.getQueueLoading);
    expect(mockStore.select).toHaveBeenCalledWith(fromPlayerStore.getQueuePagination);
  }));
