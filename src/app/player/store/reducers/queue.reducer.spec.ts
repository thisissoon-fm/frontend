...
const queueItem1: QueueItem = {
  track: {
    album: {
      id: 'f3a11314-d9fa-46b3-ab6e-3f1e5a68a784',
      images: [
        {
          url:
    ...
    artists: [
      {
        id: 'bdfc95d9-3f45-491f-a3af-db87325b3401',
        uri: 'spotify:artist:3TVXtAsR1Inumwj472S9r4',
        name: 'Drake'
      },
      {
        id: 'ec8f8c49-223d-4cb3-85cd-43f020e8d004',
        uri: 'spotify:artist:3tVQdUvClmAT7URs9V3rsp',
        name: 'WizKid'
      },
      {
        id: '4435da05-6e27-4d09-a8bf-8259373b0368',
        uri: 'spotify:artist:77DAFfvm3O9zT5dIoG0eIO',
        name: 'Kyla'
      }
    ],
    duration: 173986,
    id: '8a07912a-a99f-4ccf-aeb7-32848ba74485'
  },
  user: {
  ...
  uuid: '1d5f3e89-7f56-4068-b179-97d3d1cd9157'
};
const queueItem2: QueueItem = {
  track: {
    album: {
      id: 'c0723b1d-7fa7-427f-8a0e-0a7e46c0c68f',
      images: [
        {
          url:
        ...
        {
          url:
            'https://i.scdn.co/image/8f5f72b3aadb8829d740137fd4a217853cdf82b7',
          width: 300,
          height: 300
        },
        {
          url:
            'https://i.scdn.co/image/1233a218b7c1e900eaf160846d470cf49c314750',
          width: 64,
          height: 64
        }
      ],
    ...
    duration: 298940,
    id: '85e96979-ed23-4140-a0c2-79c19276e025'
  },
  user: {
    family_name: 'Opare-Aryee',
    display_name: 'Edward Opare-Aryee',
  ...
  uuid: 'fa42543c-90ea-43d8-97da-6369d7616986'
};
const queueItem3: QueueItem = {
  track: {
    album: {
      id: 'f3640529-a29f-4c68-822e-5b3a1679bf93',
      images: [
        {
          url:
            'https://i.scdn.co/image/d68defc78c8c70b3fb733e8ac9892cd0455fdddc',
          width: 640,
          height: 640
        },
        {
          url:
            'https://i.scdn.co/image/8978ca55e89fc664cbf672804a90ac7afb142fd0',
          width: 300,
          height: 300
        },
        {
          url:
            'https://i.scdn.co/image/c2b5f7d4b88327724b00fd6c66c47d3b22d06d74',
          width: 64,
          height: 64
        }
      ],
    ...
    artists: [
      ...
      {
        id: '175c62d3-762c-44e4-9d06-fe9bc3ef49e4',
        uri: 'spotify:artist:4V8LLVI7PbaPR0K2TGSxFF',
        name: 'Tyler, The Creator'
      },
      {
        id: '011289ac-65b9-42d1-a7a0-5e1a7a5d8696',
        uri: 'spotify:artist:57vWImR43h4CaDao012Ofp',
        name: 'Steve Lacy'
      }
    ],
    duration: 255653,
    id: '3712603a-c47a-478f-b918-ffb2471ccc26'
  },
  user: {
    family_name: 'Opare-Aryee',
    display_name: 'Edward Opare-Aryee',
  ...
  uuid: '3b18549c-eb7a-41b0-b14e-ecacca495b36'
};
const queueItem4: QueueItem = {
  track: {
    album: {
      id: '5b941d15-8abe-402e-8509-2dded27e4d5b',
      images: [
        {
          url:
            'https://i.scdn.co/image/225d4551ebc93b56b897b75c695b39ac61c4401c',
          width: 640,
          height: 640
        },
        {
          url:
            'https://i.scdn.co/image/272376cc5ce2042be360ba3359d2c7983dbb7660',
          width: 300,
          height: 300
        },
        {
          url:
            'https://i.scdn.co/image/465adefaa0e2d00c571a662d5275767ae6499cbe',
          width: 64,
          height: 64
        }
      ],
      name: 'PARTYNEXTDOOR 3 (P3)',
      uri: 'spotify:album:2FXGUAESmG5l9YPrzWPvHI'
    },
    name: 'Come and See Me (feat. Drake)',
    uri: 'spotify:track:1wZqJM5FGDEl3FjHDxDyQd',
    play_count: 0,
    artists: [
      {
        id: 'bdfc95d9-3f45-491f-a3af-db87325b3401',
      ...
      {
        id: 'cf872df6-b590-4b28-bfaa-2b9c56668210',
        uri: 'spotify:artist:2HPaUgqeutzr3jx5a9WyDV',
        name: 'PARTYNEXTDOOR'
      }
    ],
    duration: 235477,
    id: '8dce4d95-7bbd-4668-bf8e-4d37d6fe4e47'
  },
  user: {
    family_name: 'Opare-Aryee',
    display_name: 'Edward Opare-Aryee',
  ...
  uuid: 'd4f7e1f1-fec7-4ad2-b40a-647ed9f7c22f'
};
...
describe('QueueReducer', () => {
  ...
  describe('Load queue', () => {
    ...
    it('should load queue', () => {
      ...
      const action = new queueAction.LoadQueueSuccess({
        items: queue,
        pagination
      });
      const result = queueReducer.queueReducer(
  ...
  describe('Load queue item', () => {
    it('should load queue item', () => {
      ...
      const meta = {
        play_time:
          queueItem1.track.duration +
          queueItem2.track.duration +
          queueItem3.track.duration,
        genres: {},
        total: 3,
