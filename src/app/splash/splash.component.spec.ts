...
describe('SplashComponent', () => {
  ...
  it('should subscribe to store data', async(() => {
    expect(mockStore.select).toHaveBeenCalledWith(fromUserStore.getUserAuthenticated);
    expect(mockStore.select).toHaveBeenCalledWith(fromPlayerStore.getLoadedState);
  }));
