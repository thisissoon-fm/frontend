...
describe('AlbumDetailComponent', () => {
  ...
  beforeEach(async(() => {
    mockSpotifyAlbumService = {
      ...
      getTracks: jasmine.createSpy('getTracks').and.returnValue(Observable.of(tracks))
    };
  ...
  it('should get album image', async(() => {
    expect(component.albumImage).toEqual('https://i.scdn.co/image/459dbc62a8634b01fe3bbc4bc06d21cbb7b6cfde');
  }));
  ...
  it('should load more tracks', async(() => {
    ...
    expect(mockSpotifyAlbumService.getTracks).toHaveBeenCalledWith('foo', params);
  }));
