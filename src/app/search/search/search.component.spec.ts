...
describe('SearchComponent', () => {
  ...
  it('should load search results', async(() => {
    ...
    expect(mockStore.dispatch).toHaveBeenCalledWith(
      new fromSearchStore.LoadSearchResults()
    );
  }));
  ...
  it('should set search query', async(() => {
    ...
    expect(mockStore.dispatch).toHaveBeenCalledWith(
      new fromSearchStore.SetSearchQuery('foo')
    );
  }));
  ...
  it('should set search type', async(() => {
    ...
    expect(mockStore.dispatch).toHaveBeenCalledWith(
      new fromSearchStore.SetSearchType('track')
    );
  }));
  ...
  it('should clear search', async(() => {
    component.close();
    expect(mockStore.dispatch).toHaveBeenCalledWith(
      new fromSearchStore.ClearSearch()
    );
  }));
  ...
  it('should load next page of results', async(() => {
    ...
    expect(mockStore.dispatch).toHaveBeenCalledWith(
      new fromSearchStore.LoadSearchResultsNextPage()
    );
  }));
  ...
  it(
    'should set search query on search changes',
    fakeAsync(() => {
